...
import provider
import delis_lib as delis
import pdb
import h5py

parser = argparse.ArgumentParser()
parser.add_argument('--gpu', type=int, default=0, help='GPU to use [default: GPU 0]')
parser.add_argument('--model', default='delis_cls', help='Model name: delis [default: delis_cls]')
parser.add_argument('--batch_size', type=int, default=1, help='Batch Size during training [default: 1]')
parser.add_argument('--num_point', type=int, default=128, help='Point Number [default: 128]')
...
TRAIN_FILES = provider.getDataFiles( \
    os.path.join(BASE_DIR, 'data/kittiTrain.txt'))
TEST_FILES = provider.getDataFiles(\
    os.path.join(BASE_DIR, 'data/kittiTest.txt'))
...
def eval_one_epoch(sess, ops, num_votes=1, topk=1):
    ...
    current_data, order_list, pointCloud, obj_length, all_segmented_points = delis.importData(INPUT_FILE_NAME,SEG_ALG)
